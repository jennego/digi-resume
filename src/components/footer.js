            ...
            <nav class="navbar navbar-expand navbar-dark fixed-bottom ">
                <div class="container justify-content-center">
                    <div class="d-flex flex-column flex-wrap" id="navbarCollapse">
                        ...
                        <div class="navbar-text mx-auto"> <small> Copyright. 2019. Stars and planets from <a href="obsidiandawn.com"> Obsidian Dawn Photoshop Brushes</a>. Wave from <a href="https://codepen.io/tedmcdo/pen/PqxKXg">Ted McDonald on CodePen</a>.  </small> </div>
                    </div>
                </div>
            </nav>
